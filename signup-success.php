...
<div class="form">
<div class="header">
<h4 align="center">You have register successfully</h4><h6 align="center">please Enter your email and password to logon</h6>
</div>
<br>
    <form  method="post">
        <table>
       ...
       <tr></tr>
        <tr>
        <th colspan="2" class="last"><button type="submit" name="submit" class="btn btn-primary" class="text-light">Logon</button></th>
        </tr>
        <tr>
